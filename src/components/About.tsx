      ...
      <div className="container-padding">
        ...
        <div className="bg-primary/5 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto mb-16">
          <div className="text-center">
            ...
            في مِدرَسَة نؤمن أن العقول المتميزة تستحق نجاحاً علمياً ومهنياً موازياً. مدرَسة تسد الفجوة بين الخبرة الأكاديمية الطبية والإنجاز الريادي، عبر تدريب شامل في التسويق ،القيادة ، وتطوير الأعمال بشكل استراتيجي مصمم خصيصاً للقطاع الطبي.
            </p>
          </div>
        </div>
      </div>
